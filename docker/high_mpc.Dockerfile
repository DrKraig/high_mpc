...
# Set up high_mpc repository
WORKDIR ${HOME}/workspace/src/
RUN git clone https://github.com/uzh-rpg/high_mpc.git && \
    cd high_mpc && \
    pip install -r requirements.txt && \
    echo 'export PYTHONPATH=${PYTHONPATH}:$HOME/workspace/src/high_mpc' >> $HOME/.bashrc
